...
{
    public partial class QuangPhongDB : IQuerySurface
    {
        ...
        public QuangPhongDB() 
        { 
            DataProvider = ProviderFactory.GetProvider("QuangPhongMySql");
            Init();
        }

        public QuangPhongDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public QuangPhongDB(string connectionString, string providerName)
        {
